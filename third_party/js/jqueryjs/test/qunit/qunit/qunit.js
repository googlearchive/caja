...
QUnit.equiv = function () {
    ...
    var callbacks = function () {
        ...
        return {
            ...
            "date": function (b, a) {
	        // CRUFT(ihab.awad): Debug stuff
              if (cajaVM) {
	      cajaVM.log('======================================================');
	      cajaVM.log('Comparing Dates: b = ' + b + ', a = ' + a);
	      cajaVM.log('QUnit.objectType(b) = ' + QUnit.objectType(b));
	      cajaVM.log('a.valueOf() = ' + a.valueOf());
	      cajaVM.log('b.valueOf() = ' + b.valueOf());
	      cajaVM.log('typeof a.valueOf() = ' + typeof a.valueOf());
	      cajaVM.log('typeof b.valueOf() = ' + typeof b.valueOf());
	      cajaVM.log('a.valueOf() === b.valueOf() = ' + a.valueOf() === b.valueOf());
	      cajaVM.log('======================================================');
	      }
