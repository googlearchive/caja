...
set CLASSPATH="%JAR_FILE1%";"%JAR_FILE2%";"%SDK_BIN%\jetty94\jetty-home\lib\servlet-api-3.1.jar";"%SDK_LIB%\appengine-tools-api.jar";"%SDK_LIB%\opt\user\datanucleus\v1\jdo2-api-2.3-eb.jar";"%SDK_LIB%\user\*"
