...
running on web pages. A great virtue of Javascript is that many people 
successfully program in it casually, without first learning the language in 
...
run with exactly the authority explicitly provided by its containing 
document. Surprisingly, we can gain these benefits simply by applying a 
milder, non-lethal sanitizer.
