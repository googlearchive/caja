...
\begin{description}
  ...
  \ref{fig:caja-subclass}, and~\ref{fig:caja-anon-method}. Methods may thus 
...
\caption[An Anonymous Caja Method.]{An Anonymous Caja Method. xx. \\ } \hrule
\label{fig:caja-anon-method}
\end{figure}
...
\begin{tabular}{ll}
  ...
  \code{\ \ \ \ \ \ \ \ \ \ldots)} & \\
  \code{member.bind(this,\ldots)} & anonymous method closure within method \\
  \hline
