 ...
 * <code>PropertyAssignment : get PropertyName ( ) { FunctionBody }</code>
 *
...
public final class GetterProperty extends ObjProperty {
  ...
  public GetterProperty(StringLiteral name, FunctionConstructor fn) {
    super(name, fn);
  }
  ...
  public void childrenChanged() {
    ...
    // The property name is not bound to the getter function in the body of the
    // getter function.
    // From section 11.1.5:
