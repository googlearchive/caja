...
public class PlaygroundView {
  ...
  */
  ...
  public void addCompileMessageHtml(String messageHtml) {
    // The safe HTML arriving here is expected to be generated by
    // GWTCajolingServiceImpl.formatMessages.
    playgroundUI.compileMessages.add(new HTML(messageHtml));
  }

  public void addCompileMessagePlainText(String messageText) {
    playgroundUI.compileMessages.add(new Label(messageText));
  }
